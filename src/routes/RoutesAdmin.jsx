...
import FeaturedProperties from "../components/pages/developer/properties/featured-properties/FeaturedProperties.jsx";
...
export const RoutesAdmin = [
  ...
  {
    path: `${devNavUrl}/${urlAdmin}/featured-properties`,
    element: (
      <ProtectedRouteUser>
        <FeaturedProperties />
      </ProtectedRouteUser>
