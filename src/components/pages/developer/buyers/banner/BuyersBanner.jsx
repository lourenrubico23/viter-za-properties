...
import BuyersBannerTable from "./BuyersBannerTable";
import ModalAddBuyersBanner from "./ModalAddBuyersBanner";
  ...
  return (
    <>
      <div className=" bg-[#f5f5f3] ">
        <Navigation menu="buyers" submenu="buyers-banner" />
