...
import BuyersBannerTable from "./banner/BuyersBannerTable";
import ModalAddBuyersBanner from "./banner/ModalAddBuyersBanner";
...
import BuyersContactUsTable from "./buyers-contactUs/BuyersContactUsTable";
import ModalAddBuyersContactUs from "./buyers-contactUs/ModalAddBuyersContactUs";
...
const Buyers = () => {
  ...
  const handleAddBanner = () => {
    dispatch(setIsAdd({ modal: true, modalCode: "buyers-banner" }));
    setItemEdit("homeBannerUpdate");
  };

  const handleAddContactUs = () => {
    dispatch(setIsAdd({ modal: true, modalCode: "buyers-contactUs" }));
  ...
  return (
    <>
      <div className=" bg-[#f5f5f3] ">
        <Navigation menu="buyers" submenu="" />
      ...
      {store.isAdd?.modal && store.isAdd?.modalCode === "buyers-banner" && (
        <ModalAddBuyersBanner itemEdit={itemEdit} bannerData={bannerData} />
      )}
      {store.isAdd?.modal && store.isAdd?.modalCode === "buyers-contactUs" && (
