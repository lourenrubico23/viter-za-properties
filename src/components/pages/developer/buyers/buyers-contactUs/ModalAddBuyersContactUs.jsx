...
const ModalAddBuyersContactUs = ({ itemEdit, contactFormData }) => {
    ...
    mutationFn: (values) =>
      queryData(
        contactFormData?.data?.length
          ? `${devApiVersion}/contact-form/${contactFormData.data[4].form_aid}` // update
  ...
  const initVal = {
    ...
    form_page: contactFormData?.data?.[4]?.form_page ?? "Buyers",
    form_label: contactFormData?.data?.[4]?.form_label ?? "",
    form_title: contactFormData?.data?.[4]?.form_title ?? "",
    form_facebook: contactFormData?.data?.[4]?.form_facebook ?? "",
    form_instagram: contactFormData?.data?.[4]?.form_instagram ?? "",
    form_linkedIn: contactFormData?.data?.[4]?.form_linkedIn ?? "",
    form_address: contactFormData?.data?.[4]?.form_address ?? "",
    form_description: contactFormData?.data?.[4]?.form_description ?? "",
    form_contact_description:
      contactFormData?.data?.[4]?.form_contact_description ?? "",
    form_contact_disclaimer:
      contactFormData?.data?.[4]?.form_contact_disclaimer ?? "",
  };
                    ...
                    <div className="modal_container overflow-y-auto overflow-x-hidden h-[100dvh] ">
                      <div className="input-wrapper">
                        <InputSelect
                          ...
                          name="form_page"
                          disabled={
                            mutation.isPending || initVal.form_page === "Buyers"
                          }
                        >
...
export default ModalAddBuyersContactUs;
