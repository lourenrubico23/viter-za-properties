...
import ModalAddPropertyContactUs from "./ModalAddPropertyContactUs";
import PropertyContactUsTable from "./PropertyContactUsTable";

const PropertyContactUs = () => {
  ...
  return (
    <>
      <div className=" bg-[#f5f5f3] ">
        <Navigation menu="properties" submenu="property-contact-us" />
