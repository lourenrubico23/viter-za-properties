...
const Properties = () => {
  ...
  const handleAddBanner = () => {
    dispatch(setIsAdd({ modal: true, modalCode: "properties-banner" }));
    setItemEdit("homeBannerUpdate");
  };

  const handleAddContactUs = () => {
    dispatch(setIsAdd({ modal: true, modalCode: "properties-contactUs" }));
  ...
  return (
    <>
      <div className=" bg-[#f5f5f3] ">
        <Navigation menu="properties" submenu="" />
            ...
            <div className="addShadowDash bg-[#f5f5f3]">
              <div className="p-7 bg-light">
                ...
                <PropertiesBannerTable
                  ...
                  isLoading={isLoading}
                />
                <PropertiesList pageType="properties" />
                <PropertyContactUsTable
      ...
      {store.isAdd?.modal && store.isAdd?.modalCode === "properties-banner" && (
        <ModalAddPropertiesBanner itemEdit={itemEdit} bannerData={bannerData} />
      )}
      {store.isAdd?.modal &&
        store.isAdd?.modalCode === "properties-contactUs" && (
          <ModalAddPropertyContactUs
            itemEdit={itemEdit}
            contactFormData={contactFormData}
          />
        )}
