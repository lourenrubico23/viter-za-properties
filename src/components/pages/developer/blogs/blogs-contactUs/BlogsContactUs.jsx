...
import BlogsContactUsTable from "./BlogsContactUsTable";
import ModalAddBlogsContactUs from "./ModalAddBlogsContactUs";

const BlogsContactUs = () => {
  ...
  return (
    <>
      <div className=" bg-[#f5f5f3] ">
        <Navigation menu="blogs" submenu="blogs-contact-us" />
