...
import BlogsBannerTable from "./blogs-banner/BlogsBannerTable";
import ModalAddBlogsBanner from "./blogs-banner/ModalAddBlogsBanner";
import BlogsContactUsTable from "./blogs-contactUs/BlogsContactUsTable";
import ModalAddBlogsContactUs from "./blogs-contactUs/ModalAddBlogsContactUs";
...
const BlogsPage = () => {
  ...
  const handleAddBanner = () => {
    dispatch(setIsAdd({ modal: true, modalCode: "blogs-banner" }));
    setItemEdit("homeBannerUpdate");
  };

  const handleAddContactUs = () => {
    dispatch(setIsAdd({ modal: true, modalCode: "blogs-contactUs" }));
  ...
  return (
    <>
      ...
      {store.isAdd?.modal && store.isAdd?.modalCode === "blogs-banner" && (
        <ModalAddBlogsBanner itemEdit={itemEdit} bannerData={bannerData} />
      )}
      {store.isAdd?.modal && store.isAdd?.modalCode === "blogs-contactUs" && (
        <ModalAddBlogsContactUs
          itemEdit={itemEdit}
          contactFormData={contactFormData}
        />
      )}
