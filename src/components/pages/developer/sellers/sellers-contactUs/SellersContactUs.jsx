...
import ModalAddSellersContactUs from "./ModalAddSellersContactUs";
import SellersContactUsTable from "./SellersContactUsTable";

const SellersContactUs = () => {
  ...
  return (
    <>
      <div className=" bg-[#f5f5f3] ">
        <Navigation menu="sellers" submenu="sellers-contact-us" />
...
export default SellersContactUs;
