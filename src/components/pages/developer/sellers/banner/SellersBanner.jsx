...
import ModalAddSellersBanner from "./ModalAddSellersBanner";
import SellersBannerTable from "./SellersBannerTable";
  ...
  return (
    <>
      <div className=" bg-[#f5f5f3] ">
        <Navigation menu="sellers" submenu="sellers-banner" />
