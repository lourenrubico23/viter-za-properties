...
const ModalAddSellProperty = ({ itemEdit, sellPropertyData }) => {
  ...
  const initVal = {
    ...
    sell_title: sellPropertyData?.data?.[0]?.sell_title ?? "",
    sell_description: sellPropertyData?.data?.[0]?.sell_description ?? "",
    sell_button: sellPropertyData?.data?.[0]?.sell_button ?? "",
  };
    ...
    <>
      ...
      >
        <div className="modal-title">
          <h2 className="text-sm">{itemEdit ? "Edit" : "Add"} Sell Property</h2>
...
export default ModalAddSellProperty;
